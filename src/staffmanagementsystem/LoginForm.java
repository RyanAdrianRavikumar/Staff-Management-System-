...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Login Form - Staff Management System");
        ...
        jobPositionComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Staff ", "Administrator" }));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(jobPositionComboBox, 0, 195, Short.MAX_VALUE)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGap(1, 1, 1)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 40, 340, 260));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/staffmanagementsystem/88246.jpg"))); // NOI18N
        jLabel6.setText("jLabel6");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 700, 340));
...
if (jobPosition.isEmpty() || jobPosition.equals("select job position")) {
...
try {
    ...
    PreparedStatement pst = con.prepareStatement("SELECT * FROM staff WHERE LOWER(username) = ? AND password = ? AND LOWER(job_position) = ?");
    pst.setString(1, username.toLowerCase());
    pst.setString(2, password);
    pst.setString(3, jobPosition);

    // Execute query
    ResultSet rs = pst.executeQuery();

    if (rs.next()) {
        JOptionPane.showMessageDialog(null, "Welcome to the System!", "Login Successful", JOptionPane.INFORMATION_MESSAGE);
